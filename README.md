...
| *User Story* |                                             | *Work-Item / Task* |                                                                     |                                                                                                                                      |                        |                   |                                                  |
| *Id*         | *Title*                                   | *Id*               | *Title*                                                           | *Description*                                                                                                                      | *Estimation (Hours)* | *Assigned To*   | *Status* (To-do / InProcess / ToReview / Done) |
| HU02           | Ver nivel actual del agua                   | T01                  | Integración de nivel de agua y calidad (Edge + Backend)             | Implementación del reconocimiento del nivel y calidad del agua desde dispositivos embebidos, procesado en Edge y enviado al backend. | 10                     | Rodrigo Aguilar   | Done                                             |
| HU03           | Ver calidad del agua                        | T02                  | Visualización de datos procesados en dashboard admin                | Mostrar en el panel admin los datos recopilados por Edge para monitorear calidad del agua en tiempo real.                            | 6                      | Rodrigo Aguilar   | Done                                             |
| HU10           | Ver estado de suscripción                   | T03                  | Visualización de suscripciones por proveedor                        | Mostrar en web la información detallada de suscripciones activas usando los datos de sensores.                                       | 5                      | Joaquín Cortez    | Done                                             |
| HU09           | Registrar sensores                          | T04                  | Creación automática de suscripción al registrar sensor              | Al registrar un sensor, se genera automáticamente una suscripción asociada para el monitoreo.                                        | 6                      | Joaquín Cortez    | Done                                             |
| HU01           | Ver nivel actual del agua de los habitantes | T05                  | Consulta y visualización del nivel actual por parte del proveedor   | Desde el panel web, visualizar los niveles actuales del agua de todos los habitantes registrados.                                    | 5                      | Paolo Párraga     | Done                                             |
| HU14           | Segmentación de perfiles de usuario         | T06                  | Visualización de perfiles segmentados (habitante, proveedor, admin) | Mostrar claramente a qué perfil va dirigida cada funcionalidad desde la UI.                                                          | 4                      | Paolo Párraga     | Done                                             |
| HU13           | Presentación clara de beneficios            | T07                  | Diseño UI + contenido UX para comunicar beneficios                  | Reorganizar estructura de carpetas, aplicar estilos y textos claros sobre el valor de AquaConecta.                                   | 5                      | Paolo Párraga     | Done                                             |
| HU15           | Comunicación del problema y la solución     | T08                  | Visualización del problema en pantalla de inicio                    | Diseño de la sección explicativa del problema y cómo la plataforma lo resuelve.                                                      | 4                      | Michael Carmelino | Done                                             |
| HU17           | Envío de consultas por formulario           | T09                  | Formulario de contacto funcional con envío a backend                | Implementar formulario con validación, conexión y retroalimentación para el usuario.                                                 | 5                      | Alexandra Ramos   | Done                                             |
| HT01           | API para recepción de datos IoT             | T10                  | Endpoint para recepción de datos desde Edge Node                    | Desarrollo de endpoint REST para recibir datos desde sensores vía Edge.                                                              | 8                      | Rodrigo Aguilar   | Done                                             |
| HT02           | Servicio de actualización automática        | T11                  | Servicio que actualiza datos cada 60 segundos                       | Cron job o daemon que mantiene actualizados los datos de sensores para el backend.                                                   | 6                      | Rodrigo Aguilar   | Done                                             |
| HT03           | Servicio de alertas automáticas             | T12                  | Lógica para disparar alertas en condiciones críticas                | Implementación de detección automática de niveles bajos o valores anómalos.                                                          | 6                      | Michael Carmelino | Done                                             |
| HT04           | Auditoría de accesos API                    | T13                  | Middleware de logging para rutas protegidas                         | Registro de accesos a rutas sensibles para seguimiento y seguridad.                                                                  | 5                      | Paolo Párraga     | Done                                             |
| HU12           | Acceso desde dispositivo móvil              | T14                  | Mejoras en estilo y responsividad de app móvil                      | Ajustes visuales en pantallas móviles para uso fluido desde celular.                                                                 | 4                      | Paolo Párraga     | Done                                             |
